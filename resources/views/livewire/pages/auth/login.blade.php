    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="max-w-6xl mx-auto">
            <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
                <div class="flex flex-col lg:flex-row min-h-[560px]">
                    <!-- Illustration (optional) -->
                    <div
                        class="lg:w-1/2 illustration-wrapper p-8 lg:p-12 relative bg-gradient-to-br from-primary to-primary-dark">
                        <div class="relative z-10 h-full flex flex-col justify-center text-white">
                            ...
                            <div class="absolute bottom-10 right-10 w-24 h-24 bg-white/10 rounded-full blur-2xl"></div>
                        </div>
                    </div>
                            ...
                            <form wire:submit="login" class="space-y-5">
                                ...
                                <div>
                                    ...
                                    <input id="email" type="email" required autocomplete="email"
                                        ...
                                        class="w-full rounded-xl border-gray-300 focus:ring-2 focus:ring-primary focus:border-primary-dark"
                                ...
                                <button type="submit"
                                    class="w-full mt-2 inline-flex items-center justify-center gap-2 px-4 py-3 rounded-xl font-semibold text-white bg-gradient-to-r from-primary to-primary-dark hover:from-primary-dark hover:to-primary-hover shadow-md hover:shadow-lg transition">
                                    Masuk
                                </button>
